...
class HashtagClassifier(AlbertPreTrainedModel):
    def __init__(self, bert_config):
        ...
        self.text_classifier = FCLayer(bert_config.hidden_size, 100, 0, use_activation=False)
        self.img_classifier = FCLayer(512*7*7, 100, 0, use_activation=False)

        self.label_classifier = FCLayer(200, self.num_labels, 0, use_activation=True)
